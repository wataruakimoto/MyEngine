...
void GameScene::Initialize() {
	...
	// エミッタ生成
	particleEmitter = std::make_unique <ParticleEmitter>("circle", transfromEmitter, 5, 0.5f);
	particleEmitter2 = std::make_unique <ParticleEmitter>("uv", transfromEmitter2, 5, 0.5f);
}
