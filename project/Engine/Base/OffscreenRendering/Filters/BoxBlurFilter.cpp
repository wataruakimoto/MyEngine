...
void BoxBlurFilter::Initialize(DirectXUtility* dxUtility, PostEffect* postEffect) {
...
void BoxBlurFilter::CreateInputLayout() {
...
void BoxBlurFilter::CreateBlendState() {

	// すべての色要素を書き込む
	blendDesc.RenderTarget[0].RenderTargetWriteMask = D3D12_COLOR_WRITE_ENABLE_ALL;
}

void BoxBlurFilter::CreateRasterizerState() {
...
void BoxBlurFilter::CreateVertexShader() {
...
void BoxBlurFilter::CreatePixelShader() {

	// シェーダコンパイルを行う
	pixelShaderBlob = dxUtility->CompileShader(L"resources/shaders/BoxBlur.PS.hlsl", L"ps_6_0");
	assert(pixelShaderBlob != nullptr);
}

void BoxBlurFilter::CreateDepthStencilState() {

	// 全画面に対して処理を行うので、比較や書き込みの必要がない
	depthStencilDesc.DepthEnable = false;
}

void BoxBlurFilter::CreateGraphicsPipeline() {
