...
void FullScreenFilter::CreateInputLayout() {
...
void FullScreenFilter::CreateBlendState() {

	// すべての色要素を書き込む
	blendDesc.RenderTarget[0].RenderTargetWriteMask = D3D12_COLOR_WRITE_ENABLE_ALL;
}

void FullScreenFilter::CreateRasterizerState() {
...
void FullScreenFilter::CreateVertexShader() {
...
void FullScreenFilter::CreatePixelShader() {
...
void FullScreenFilter::CreateDepthStencilState() {
